# Last Orbit (codename: orbita) — Contexto do projeto pra Codex

> Este arquivo é lido automaticamente pelo Codex em qualquer nova sessão neste diretório.
...
```
Continuando o trabalho do Last Orbit. Lê o NEXT_SESSION.md no projeto pra status atual + AGENTS.md pra contexto técnico.
```
